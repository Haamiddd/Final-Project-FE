...
const CricketBooking = () => {
  ...
  useEffect(() => {
    ...
    const todaysBookings = existingBookings.filter(booking => booking.sport === 'Cricket' && booking.date === selectedDate.toLocaleDateString());
  ...
  return (
    <div className="background-cric p-5">
      <Header/>
